...
class testCaseTwenty(baseMethods):
    ...
    __private_cartPage=(By.CSS_SELECTOR, "a[href='/view_cart']")
    # Action Methosds
    ...
    def verifyPageTitle(self):
        ...
        assert text.lower()== "All Products".lower() , "Page Title didn't match"

    def searchActions(self):
        self.clear_element(self.__private_searchBox)
        self.send_keys(self.__private_searchBox , "Saree")
        self.click(self.__private_submitSearch)
    ...
    def clickCartPage(self):
        self.click(self.__private_cartPage)