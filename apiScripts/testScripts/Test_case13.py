...
class Test_caseThirteen(BaseMethod):
    @pytest.mark.order(13)
    def test_caseThirteen(self,base_attribute):
        """
            PUT METHOD To Update User Account
        """
        url=base_attribute['url']+"/updateAccount"
        ...
        apiCall=self.put_method(url=url,body=body,time=5)
